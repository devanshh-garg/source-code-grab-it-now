/*
  ...
  2. Security
    ...
    - Add policies for business owners to view their customers
*/
...
CREATE POLICY "Customers can join loyalty programs"
  ...
  WITH CHECK (customer_profile_id IN (
    SELECT id FROM customer_profiles WHERE user_id = uid()
  ));
...
-- Business owners can view their customers' cards
