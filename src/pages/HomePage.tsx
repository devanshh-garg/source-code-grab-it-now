          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><button onClick={scrollToFeatures} className="text-base text-gray-500 hover:text-gray-900 transition-colors">Features</button></li>
                <li><a href="#pricing" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Pricing</a></li>
                <li><a href="#integrations" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Integrations</a></li>
                <li><a href="#case-studies" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Case Studies</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">Resources</h3>
              <ul className="space-y-3">
                <li><a href="#docs" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Documentation</a></li>
                <li><a href="#blog" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Blog</a></li>
                <li><a href="#support" className="text-base text-gray-500 hover:text-gray-900 transition-colors">Support</a></li>
                <li><a href="#api" className="text-base text-gray-500 hover:text-gray-900 transition-colors">API Reference</a></li>
              </ul>
            </div>
            <div>
